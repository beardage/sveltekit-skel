...
var Faq$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    ...
    ""
  ].join(" ").trim()}"><svg xmlns="${"http://www.w3.org/2000/svg"}" width="${"16"}" height="${"16"}" fill="${"currentColor"}" class="${"bi bi-chevron-right"}" viewBox="${"0 0 16 16"}"><path fill-rule="${"evenodd"}" d="${"M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"}"></path></svg></div></div>
	<div class="${[
    "answer z-10 overflow-hidden transition-all transform-gpu duration-150 ease-in-out svelte-183qm3u",
    "answer--hidden "
  ].join(" ").trim()}"><p class="${"z-10"}">${escape2(faq2.answer)}</p></div>
</div>`;
});
